...
class config:
	...
	#@-body
	#@-node:14::setAllDicts
	#@+node:15:C=7:setCommandsFindIvars
	#@+body
	...
	#@-body
	#@-node:16:C=8:setCommandsIvars
	#@+node:17:C=9:setConfigFindIvars
	#@+body
