...
if wx: # Enable the plugin (only if wxPython has been imported)...
    ...
    class wxGui(leoGui.leoGui):
        ...
        def getFontFromParams(self,family,size,slant,weight):
            ...
            ## trace(g.app.config.defaultFont)
        ...
        def getAllText (self,t):
            ...
            if s is None:
                ...
                return toUnicode(s,g.app.tkEncoding)
        #@nonl
        #@-node:edream.111303093953.18:getAllText
        ...
        def getCharAfterIndex (self,t,index):
            ...
            ch = t.get(index + "+1c")
            return toUnicode(ch,g.app.tkEncoding)
        #@nonl
        #@-node:edream.111303093953.19:getCharAfterIndex
        ...
        def getLineContainingIndex (self,t,index):
            ...
            return toUnicode(line,g.app.tkEncoding)
        #@nonl
        #@-node:edream.111303093953.22:getLineContainingIndex
    ...
    class wxLeoApp (wx.wxApp):
        ...
        #@    @+others
        #@+node:edream.110203113231.347:OnInit
        def OnInit(self):
    ...
    class wxLeoBody (leoFrame.leoBody):
        ...
        #@    @+others
        #@+node:edream.110203113231.540:Birth & death
    ...
    class wxLeoFrame(wx.wxFrame,leoFrame.leoFrame):
        ...
        #@    @+others
        #@+node:edream.110203113231.350:Birth & death
        ...
        #@nonl
        #@-node:edream.110203113231.351:__repr__
        #@+node:edream.110203113231.260:finishCreate
        ...
        def injectCallbacks(self):
            ...
            for name in (
                ...
                # trace(f)
                funcToMethod(doNothingCallback,leoNodes.vnode,name=name)
        #@nonl
        #@-node:edream.111503105816:injectCallbacks
    ...
    class wxLeoTree (leoFrame.leoTree):
        ...
        #@nonl
        #@-node:edream.111603213219.1:__init__
        #@+node:edream.111603221005:expandAllAncestors
        ...
        #@-node:edream.110203113231.300:redraw_subtree
        #@-node:edream.111303202917:Tree refresh
        #@+node:edream.111603221343.1:select
        ...
        def onTreeChanged(self,event):
            ...
            c.selectVnode(v)
            s = v.t.bodyString
            s = toUnicode(s,"utf-8")  # No g.app.tkEncoding or similar yet.
    ...
    if g.app.gui is None:
        #@        << Set app.gui >>
        #@+node:edream.110203113231.304:<< set app.gui >>
        g.app.gui = wxGui()
