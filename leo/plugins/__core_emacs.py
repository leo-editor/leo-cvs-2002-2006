...
def init ():
    ...
    return ok
#@-node:ekr.20050723062822.2:init
#@+node:ekr.20050723063811:class editCommands ( to be removed)
class editCommands:

    #@    @+others
    #@+node:ekr.20050723063811.1:ctor
    def __init__ (self,c):
    ...
    #@nonl
    #@-node:ekr.20050723063811.1:ctor
    #@+node:ekr.20050723063811.2:Options...
    #@+node:ekr.20050723063811.3:setDefaultOptions
    ...
    #@nonl
    #@-node:ekr.20050723063811.3:setDefaultOptions
    #@+node:ekr.20050723063811.4:getOption
    ...
    #@-node:ekr.20050723063811.4:getOption
    #@-node:ekr.20050723063811.2:Options...
    #@+node:ekr.20050723063811.5:Word stuff...
    #@+node:ekr.20050723063811.6:findWordStart
    ...
    #@nonl
    #@-node:ekr.20050723063811.6:findWordStart
    #@+node:ekr.20050723063811.7:insideWord
    ...
    #@nonl
    #@-node:ekr.20050723063811.7:insideWord
    #@+node:ekr.20050723063811.8:skipWord
    ...
    #@nonl
    #@-node:ekr.20050723063811.8:skipWord
    #@+node:ekr.20050723063811.9:startsWord
    ...
    #@nonl
    #@-node:ekr.20050723063811.9:startsWord
    #@+node:ekr.20050723063811.10:setDefaultWordChars
    ...
    #@-node:ekr.20050723063811.10:setDefaultWordChars
    #@-node:ekr.20050723063811.5:Word stuff...
    #@+node:ekr.20050723063811.11:Cursor movement
    #@+node:ekr.20050723063811.12:moveBackwardChar
    ...
    #@nonl
    #@-node:ekr.20050723063811.12:moveBackwardChar
    #@+node:ekr.20050723063811.13:moveBackwardWord (Finish)
    ...
    #@nonl
    #@-node:ekr.20050723063811.13:moveBackwardWord (Finish)
    #@+node:ekr.20050723063811.14:moveForwardChar
    ...
    #@nonl
    #@-node:ekr.20050723063811.14:moveForwardChar
    #@+node:ekr.20050723063811.15:moveForwardWord
    ...
    #@nonl
    #@-node:ekr.20050723063811.15:moveForwardWord
    #@+node:ekr.20050723063811.16:selectWord
    #@-node:ekr.20050723063811.16:selectWord
    #@+node:ekr.20050723063811.17:selectForwordWord
...
def createEmacs (tag, keywords):
    ...
    if 1:
        emacs = emacsCommands(c)
        emacsMenus(c,emacs)
        emacsBindings(c,emacs)
    else:
        e = leoEmacs(
            editor = None, ##
            minibuffer = None, ##
...
#@nonl
#@-node:ekr.20050723062822.4:addCommand
#@+node:ekr.20050723062822.5:class emacsCommands
class emacsCommands:
    ...
    #@    @+others
    #@+node:ekr.20050723062822.7:leoEmacs.ctor
    def __init__( self, c, editor=None, minibuffer=None, commandlabel=None, extracommands = None ):
    ...
    #@nonl
    #@-node:ekr.20050723062822.8:management listening
    #@+node:ekr.20050723062822.11:lookForExtensions
...
#@nonl
#@-node:ekr.20050723093904.2:class emacsBindings
#@+node:ekr.20050723105349.2:bugs fixed
#@+node:ekr.20050723100523.10:buildBufferList
# Surprisingly fast on LeoPy.
def buildBufferList(self):
    '''Build a buffer list from an outline.'''
...
#@nonl
#@-node:ekr.20050723100523.10:buildBufferList
#@+node:ekr.20050723105558:buildBufferList (original)
