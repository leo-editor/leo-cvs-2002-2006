...
if tkFileDialog: # Register the handlers...
    ...
    # Dear Leo users,
    # 
    # Here's my first attempt at customizing leo. I wanted to have the ability 
    # to
    # import files in "read-only" mode, that is, in a mode where files could 
    # only
    # be read by leo (not tangled), and also kept in sync with the content on 
    # the
    # drive.
    # 
    # The reason for this is for example that I have external programs that 
    # generate
    # resource files. I want these files to be part of a leo outline, but I 
    # don't
    # want leo to tangle or in any way modify them. At the same time, I want 
    # them
    ...
    # 
    # - If the @read-only directive was in the leo outline already, and the 
    # file content
    ...
    # other hand,
    # the file content has _not_ changed, the file is simply read and the node 
    # is
    # not marked as changed.
    # 
    # - When you write a @read-only directive, the file content is added to 
    # the node
    ...
    # 
    # If FTP authentication (username/password) is required, it can be 
