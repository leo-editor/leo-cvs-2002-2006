...
class tangleCommands:
	...
	#@-body
	#@-node:13::setRootFromText
	#@+node:14::skip_CWEB_section_name
	#@+body
	#@+at
	...
	#@-body
	#@-node:14::skip_CWEB_section_name
	#@+node:15::skip_noweb_section_name
	#@+body
	#@+at
